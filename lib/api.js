...
const dedupGet = (url, config = {}) => {
  ...
  // Transform perPage to page_size for Django REST Framework
  if (config.params && config.params.perPage) {
    config.params.page_size = config.params.perPage;
    delete config.params.perPage;
  }
...
export const productAPI = {
  ...
  variants: (params) => dedupGet('/products/variants/', { params }),
