...
export default function ProductDetailPage() {
  ...
  const stockColor = totalStock === 0
    ...
    : totalStock <= 10
      ? 'text-violet-600 bg-orange-50 dark:bg-orange-900/20'
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 shadow-sm">
              ...
              {product.category_name && (
                <p className="text-sm text-slate-500 dark:text-gray-400 mt-2 flex items-center gap-1.5">
                  <Tag className="w-3.5 h-3.5 text-violet-500" /> {product.category_name}
                </p>
              )}
              {product.description && (
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-semibold text-slate-900 dark:text-white mt-1 capitalize flex items-center gap-1.5">
                        {isCatalog ? <Layers className="w-3.5 h-3.5 text-violet-500" /> : <Package className="w-3.5 h-3.5 text-violet-500" />}
              ...
              <dl className="space-y-3">
                ...
                {isCatalog && (
                  <div className="flex justify-between">
                    ...
                    <dd className="text-sm font-bold text-violet-500">{product.variants_count || (product.variants || []).length}</dd>
                  </div>
                )}
                <div className="flex justify-between">
            ...
            <table className="w-full text-left">
              ...
              <tbody className="divide-y divide-gray-100">
                {product.variants.map(v => {
                  ...
                  const vStockColor = vStock === 0 ? 'bg-rose-100 text-rose-700' : vStock <= 10 ? 'bg-orange-100 text-orange-700 dark:text-violet-400' : 'bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400';
                  return (
